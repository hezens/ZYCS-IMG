<template>
  <section class="Home pt-4 sm:pt-6">
    <Alert class="pt-0 pb-2 sm:py-4">
      <AlertTitle class="font-bold hidden sm:flex sm:gap-2"> <RocketIcon class="h-4 w-4 hidden sm:flex" /> Hi there !</AlertTitle>
      <AlertDescription class="p-0 text-xs sm:text-sm">
        <p class="pt-2">感谢<a class="text-slate-400" href="https://www.vvhan.com" target="_blank" title="韩小韩博客">韩小韩博客</a> 支持并维护的文件上传项目：<a class="text-[#0969da]" href="https://github.com/uxiaohan/ZYCS-IMG" target="_blank">骤雨重山图床</a></p>
        <p>基于cloudflare pages 实现.</p>
      </AlertDescription>
    </Alert>
